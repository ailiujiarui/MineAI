...
export class History {
    constructor(agent) {
        ...
        this.botRoot = resolveRunPath('bots', this.name);
        this.memory_fp = `${this.botRoot}/memory.json`;
        this.full_history_fp = undefined;

        mkdirSync(`${this.botRoot}/histories`, { recursive: true });
    ...
    async appendFullHistory(to_store) {
        if (this.full_history_fp === undefined) {
            ...
            this.full_history_fp = `${this.botRoot}/histories/${string_timestamp}.json`;
